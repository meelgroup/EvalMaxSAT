...
struct External {
  ...
  int conflict_size();
  bool find_up_implicants(const std::vector<int>& antecedents, std::vector<int>& implicants);
  bool find_up_implicants(const std::set<int>& antecedents, std::vector<int>& implicants);
